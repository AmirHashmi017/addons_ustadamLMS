...
class ManagerRequest(models.Model):
    ...
    message = fields.Text(string='Message', help="Reason for requesting user role")
    ...
    def action_approve_request(self):
        ...
        user.write({
            'groups_id': [
                ...
                (4, self.env.ref('tamang_loan_management.loan_management_group_user').id),  # Add Loan User group
            ]
        })
